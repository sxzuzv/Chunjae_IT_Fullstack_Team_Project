package kr.co.chunjae.common.log;
...
public class LoggingAdvice {
	...
	@Before("execution(* kr.co.chunjae.*.service.*.*(..)) || "
			+ "execution(* kr.co.chunjae.*.dao.*.*(..))")
	...
	@After("execution(* kr.co.chunjae.*.service.*.*(..)) || "
			+ "execution(* kr.co.chunjae.*.*.dao.*.*(..))")
	...
	@Around("execution(* kr.co.chunjae.*.service.*.*(..)) || "
			+ "execution(* kr.co.chunjae.*.dao.*.*(..))")
