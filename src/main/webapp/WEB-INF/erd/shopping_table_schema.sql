...
(
    ...
    goods_filename varchar(60) comment '상품이미지파일이름',
...
VALUES(344, '초보자를 위한 자바 프로그래밍', '이병승', '인포북', 30000, 27000, '2018-10-02', 996, '2323454566778', 2000, '2018-10-18 ', 'newbook', '7777', '77777', '7777', '7777', NULL);
...
INSERT INTO T_SHOPPING_GOODS
(GOODS_ID, GOODS_TITLE, GOODS_WRITER, GOODS_PUBLISHER, GOODS_PRICE, GOODS_SALES_PRICE, GOODS_PUBLISHED_DATE, GOODS_TOTAL_PAGE, GOODS_ISBN, GOODS_DELIVERY_PRICE, GOODS_DELIVERY_DATE, GOODS_STATUS, GOODS_INTRO, GOODS_WRITER_INTRO, GOODS_PUBLISHER_COMMENT, GOODS_RECOMMENDATION, GOODS_CONTENTS_ORDER)
VALUES(354, '모두의 딥러닝', '이병승', '인포북', 27000, 21600, '2018-10-02', 996, '2323454566778', 2000, '2018-10-18 ', 'newbook', '7777', '77777', '7777', '7777', NULL);
...
VALUES(400, '진짜 쓰는 실무 엑셀', '오빠두(전진권)', '제이펍', 21000, 18900,
       '2022-02-15', 508, '9791191600704', 0,
       '2024-01-05', '실무엑셀_메인.jpg', 'bestseller',
-- goods intro
       '대기업 직장 생활 10년의 실무 노하우와 엑셀 유튜브 채널을 운영하면서 들은 수많은 직장인의 고민을 해결할 수 있는 다양한 엑셀 비법을 담았다. ‘진짜 쓰는 실무 엑셀’ 한 권이면 빠른 일 처리로 워라밸을 실현하고, 일잘러로 거듭날 수 있다!
...
-- writer intro
       '대기업에서 직장 생활을 하면서 실무 엑셀을 익혔고, 현재는 구독자 50만의 ‘오빠두엑셀’ 유튜브 채널과 엑셀 전문 홈페이지를 운영한다. 모든 직장인이 일잘러가 되길 바라며, 현업 및 강의 경험을 토대로 쌓은 엑셀 필수 공식과 핵심 기능 등 회사에서 꼭 필요한 엑셀 노하우를 가르치는 데도 힘쓰고 있다. 마이크로소프트에서 최고 전문가로 인정한 엑셀 MVP이며, 삼성전자, 네이버, 서울시 교육청 등 여러 기관 및 기업을 대상으로 강의 및 컨설팅을 진행하고 있다.',
-- publisher comment
       '개념 정리는 이제 그만, 실무 활용도 100%, 진짜 쓰는 실전 예제를 활용하여 기초는 빠르게, 실무는 제대로 배울 수 있습니다. 100% 맞춤형 무료 동영상 강의는 서비스!
       대상 독자
       ● 데이터 관리부터 보고서 작성까지 업무 대부분을 엑셀로 처리하는 직장인
       ● 기본적인 엑셀 사용법은 알지만, 일 처리가 서투른 신입사원
       ● 데이터 분석 및 시각화를 위해 엑셀을 사용하려는 마케터
       ● 완벽하게 준비해서 취업하고 싶은 예비 직장인', NULL,
-- GOODS_CONTENTS_ORDER
       'CHAPTER 01 시작부터 남다른 실무자의 엑셀 활용
...
INSERT INTO T_SHOPPING_GOODS
(GOODS_ID, GOODS_TITLE, GOODS_WRITER, GOODS_PUBLISHER, GOODS_PRICE, GOODS_SALES_PRICE, GOODS_PUBLISHED_DATE, GOODS_TOTAL_PAGE, GOODS_ISBN, GOODS_DELIVERY_PRICE, GOODS_DELIVERY_DATE, GOODS_FILE_NAME, GOODS_STATUS, GOODS_INTRO, GOODS_WRITER_INTRO, GOODS_PUBLISHER_COMMENT, GOODS_RECOMMENDATION, GOODS_CONTENTS_ORDER)
VALUES(401, '개발자 오늘도 마음 튼튼하게 성장하기', '피오다르 서재나베츠 · 이미령 번역', '길벗', 27500, 24750,
       '2023-12-13', 380, '9791140707591', 0, '2024-01-05', '개발자마음성장_메인.jpg', 'newbook',
...
INSERT INTO T_SHOPPING_GOODS
(GOODS_ID, GOODS_TITLE, GOODS_WRITER, GOODS_PUBLISHER, GOODS_PRICE, GOODS_SALES_PRICE, GOODS_PUBLISHED_DATE, GOODS_TOTAL_PAGE, GOODS_ISBN, GOODS_DELIVERY_PRICE, GOODS_DELIVERY_DATE, GOODS_FILE_NAME, GOODS_STATUS, GOODS_INTRO, GOODS_WRITER_INTRO, GOODS_PUBLISHER_COMMENT, GOODS_RECOMMENDATION, GOODS_CONTENTS_ORDER)
VALUES(402, 'IT 세계의 괴물들(아무나 이해할 수 있는 IT 이야기)', '아무준수', '생능북스', 19800, 17820,
       '2024-01-10', 416, '9791192932361', 0, '2024-01-03', 'monsters_메인.jpg', 'newbook',
       '지금까지 이런 책은 없었다!
       ...
       디지털 세상이 0과 1만 가득한 무미건조한 세상인 줄 알았다면, 이 책을 통해 코믹한 캐릭터들과 공감해보기를 바라며, 디지털 세대를 키우는 부모님 등을 위한 맞춤형 IT 교양서로도 추천합니다.', '현대자동차 그룹사의 R&D 기획팀 출신으로 제어시스템 및 제어 소프트웨어 관련 업무를 담당했다. 퇴사 후 웹 개발 IT 스타트업을 창업하지만 사이버 보안을 등한시 하다 랜섬웨어로 인해 사업을 접게 되었는데, 이 경험은 IT 회사에 사이버 보안 엔지니어로 취업하게 된 계기가 되었다. 현재는 외국계 IT 회사의 엔지니어링 본부 Head를 맡고 있으며, 종종 취미로 인스타그램에 IT 기술을 캐릭터화 시켜 올리던 개그 만화가 책으로 엮어지게 되었다.', '어렵지만 익숙한
낯설지만 친숙한
디지털 세상을 캐릭터로 이해하자!
이 책은 글쓴이가 종종 취미로 IT 기술을 캐릭터화시켜 인스타그램에 올리던 개그 만화를 책으로 엮은 것입니다. 이 책을 통해 글쓴이가 말해주는 디지털 세상의 괴물들(?)은 무엇이 있는지 쉽게 이해할 수 있고, 우리가 모르고 지나쳐서 큰 사고로 유발(예 : 자동차 급발진)되는 것은 없었는지 등을 알 수 있습니다. 꼭 한 번은 편하게 읽으며 공감을 얻었으면 하는 바람입니다.', NULL, NULL);
INSERT INTO T_GOODS_DETAIL_IMAGE
(IMAGE_ID, GOODS_ID, FILE_NAME, REG_ID, FILE_TYPE)
...
INSERT INTO T_SHOPPING_GOODS
(GOODS_ID, GOODS_TITLE, GOODS_WRITER, GOODS_PUBLISHER, GOODS_PRICE, GOODS_SALES_PRICE, GOODS_PUBLISHED_DATE, GOODS_TOTAL_PAGE, GOODS_ISBN, GOODS_DELIVERY_PRICE, GOODS_DELIVERY_DATE, GOODS_FILE_NAME, GOODS_STATUS, GOODS_INTRO, GOODS_WRITER_INTRO, GOODS_PUBLISHER_COMMENT, GOODS_RECOMMENDATION, GOODS_CONTENTS_ORDER)
VALUES(403, 'AWS 교과서', '김원일 , 서종호 , 김석필 ', '길벗', 38000, 34200, '2023-10-20', 480, '9791140706662', 0, '2024-01-03', 'AWS 교과서_메인.jpg', 'bestseller', '이론과 실습으로 배우는 AWS!
...
이 책은 컴퓨팅, 네트워킹, 부하분산, 스토리지, 데이터베이스 등 실제 많이 사용하는 서비스를 중심으로 AWS가 제공하는 서비스를 설명한다. 기본 서비스 외에도 고급 네트워킹 서비스와 실전 프로젝트를 수록해 기본부터 실전까지 모두 익힐 수 있다. 무엇보다 AWS 기본 개념과 핵심 기능을 ‘직접 손으로 따라 하면서’ 공부할 수 있게 매 장마다 실습 코너를 넣었으며, 학습한 뒤에 다시 복기할 수 있게 ‘요약’ 코너도 넣어서 제대로 공부하고 싶은 사람에게 안성맞춤인 책이다. 한 번 읽어보고 내려놓는 게 아닌, 실전형으로 입문하고 싶다면 이 책으로 시작해보길 강력하게 추천한다.', NULL, '1장 AWS란
1.1 클라우드 컴퓨팅
1.2 AWS 서비스
...
INSERT INTO T_SHOPPING_GOODS
(GOODS_ID, GOODS_TITLE, GOODS_WRITER, GOODS_PUBLISHER, GOODS_PRICE, GOODS_SALES_PRICE, GOODS_PUBLISHED_DATE, GOODS_TOTAL_PAGE, GOODS_ISBN, GOODS_DELIVERY_PRICE, GOODS_DELIVERY_DATE, GOODS_FILE_NAME, GOODS_STATUS, GOODS_INTRO, GOODS_WRITER_INTRO, GOODS_PUBLISHER_COMMENT, GOODS_RECOMMENDATION, GOODS_CONTENTS_ORDER)
VALUES(404, 'CODE', '찰스 펫졸드 저자(글) · 김현규 번역', '인사이트', 35000, 31500, '2023-12-22', 624, '9788966264285', 0, '2024-01-03', 'CODE_메인.jpg', 'newbook', '23년 만에 돌아온 컴퓨터 공학 분야의 필독서!
...
-- 게시판 종류 테이블 데이터
insert into categories(cate, cate_name) values(1, '공지사항');
insert into categories(cate, cate_name) values(2, '서비스 문의');
insert into categories(cate, cate_name) values(31, '환불');
insert into categories(cate, cate_name) values(32, '배송');
insert into categories(cate, cate_name) values(33, '기타');
insert into categories(cate, cate_name) values(4, '상품 후기');


-- 게시판 테이블 더미 데이터
-- cate 1) '공지사항' (관리자 작성)
INSERT INTO board(member_id, title, content, cate) VALUES('admin', '무료배송 가능 주문금액 변경 안내', '공지사항입니다.', 1);
INSERT INTO board(member_id, title, content, cate) VALUES('admin', '신정 출고 일정 및 고객센터 휴무 안내', '공지사항입니다.', 1);
INSERT INTO board(member_id, title, content, cate) VALUES('admin', '내부 점검으로 인한 출고 일정 안내', '공지사항입니다.', 1);
INSERT INTO board(member_id, title, content, cate) VALUES('admin', '위탁 배달원 휴무로 인한 배송 지연 안내', '공지사항입니다.', 1);
INSERT INTO board(member_id, title, content, cate) VALUES('admin', '개인정보처리방침 개정 사전 안내', '공지사항입니다.', 1);
INSERT INTO board(member_id, title, content, cate) VALUES('admin', '판매 종료 도서 안내', '공지사항입니다.', 1);
INSERT INTO board(member_id, title, content, cate) VALUES('admin', '품절 도서 재입고 안내', '공지사항입니다.', 1);
INSERT INTO board(member_id, title, content, cate) VALUES('admin', '물류 내부 점검으로 인한 출고 지연 안내', '공지사항입니다.', 1);
INSERT INTO board(member_id, title, content, cate) VALUES('admin', '신도서 입고 안내', '공지사항입니다.', 1);
INSERT INTO board(member_id, title, content, cate) VALUES('admin', '도서 상태 불량에 대한 처리 안내', '공지사항입니다.', 1);
INSERT INTO board(member_id, title, content, cate) VALUES('admin', '내부 점검으로 인한 출고 일정 안내', '공지사항입니다.', 1);
INSERT INTO board(member_id, title, content, cate) VALUES('admin', '판매 종료 도서 안내', '공지사항입니다.', 1);
INSERT INTO board(member_id, title, content, cate) VALUES('admin', '위탁 배달원 휴무로 인한 배송 지연 안내', '공지사항입니다.', 1);
INSERT INTO board(member_id, title, content, cate) VALUES('admin', '무료배송 가능 주문금액 변경 안내', '공지사항입니다.', 1);
INSERT INTO board(member_id, title, content, cate) VALUES('admin', '신년 이벤트 당첨자 발표', '2024 용의 해, 새해 복 많이 받으세요. 신년 이벤트 당첨자를 발표합니다. 아래의 휴대폰 번호를 확인해주세요.', 1);

-- cate 2) '서비스 문의' (사용자 작성)
INSERT INTO board(member_id, title, content, cate, com_status) VALUES('lee', '문의합니다.', '문의합니다.', 2, 'y');
INSERT INTO board(member_id, title, content, cate, com_status) VALUES('lee', '문의합니다.', '문의합니다.', 2, 'y');
INSERT INTO board(member_id, title, content, cate, com_status) VALUES('lee', '문의합니다.', '문의합니다.', 2, 'y');
INSERT INTO board(member_id, title, content, cate, com_status) VALUES('lee', '문의합니다.', '문의합니다.', 2, 'y');
INSERT INTO board(member_id, title, content, cate, com_status) VALUES('lee', '문의합니다.', '문의합니다.', 2, 'y');
INSERT INTO board(member_id, title, content, cate) VALUES('lee', '문의합니다.', '문의합니다.', 2);
INSERT INTO board(member_id, title, content, cate) VALUES('lee', '문의합니다.', '문의합니다.', 2);
INSERT INTO board(member_id, title, content, cate) VALUES('lee', '문의합니다.', '문의합니다.', 2);
INSERT INTO board(member_id, title, content, cate) VALUES('lee', '문의합니다.', '문의합니다.', 2);
INSERT INTO board(member_id, title, content, cate) VALUES('lee', '문의합니다.', '문의합니다.', 2);
...
-- cate 31) '환불' (사용자 작성)
INSERT INTO board(goods_id, member_id, title, content, cate, com_status) VALUES(400, 'lee', '환불 문의입니다.', '환불 문의입니다.', 31, 'y');
INSERT INTO board(goods_id, member_id, title, content, cate, com_status) VALUES(400, 'lee', '환불 문의입니다.', '환불 문의입니다.', 31, 'y');
INSERT INTO board(goods_id, member_id, title, content, cate, com_status) VALUES(400, 'lee', '환불 문의입니다.', '환불 문의입니다.', 31, 'y');
INSERT INTO board(goods_id, member_id, title, content, cate, com_status) VALUES(400, 'lee', '환불 문의입니다.', '환불 문의입니다.', 31, 'y');
INSERT INTO board(goods_id, member_id, title, content, cate, com_status) VALUES(400, 'lee', '환불 문의입니다.', '환불 문의입니다.', 31, 'y');
INSERT INTO board(goods_id, member_id, title, content, cate) VALUES(400, 'lee', '환불 문의입니다.', '환불 문의입니다.', 31);
INSERT INTO board(goods_id, member_id, title, content, cate) VALUES(400, 'lee', '환불 문의입니다.', '환불 문의입니다.', 31);
INSERT INTO board(goods_id, member_id, title, content, cate) VALUES(400, 'lee', '환불 문의입니다.', '환불 문의입니다.', 31);
INSERT INTO board(goods_id, member_id, title, content, cate) VALUES(400, 'lee', '환불 문의입니다.', '환불 문의입니다.', 31);
INSERT INTO board(goods_id, member_id, title, content, cate) VALUES(400, 'lee', '환불 문의입니다.', '환불 문의입니다.', 31);
...
-- cate 32) '배송' (사용자 작성)
INSERT INTO board(goods_id, member_id, title, content, cate, com_status) VALUES(400, 'lee', '배송 문의입니다.', '배송 문의입니다.', 32, 'y');
INSERT INTO board(goods_id, member_id, title, content, cate, com_status) VALUES(400, 'lee', '배송 문의입니다.', '배송 문의입니다.', 32, 'y');
INSERT INTO board(goods_id, member_id, title, content, cate, com_status) VALUES(400, 'lee', '배송 문의입니다.', '배송 문의입니다.', 32, 'y');
INSERT INTO board(goods_id, member_id, title, content, cate, com_status) VALUES(400, 'lee', '배송 문의입니다.', '배송 문의입니다.', 32, 'y');
INSERT INTO board(goods_id, member_id, title, content, cate, com_status) VALUES(400, 'lee', '배송 문의입니다.', '배송 문의입니다.', 32, 'y');
INSERT INTO board(goods_id, member_id, title, content, cate) VALUES(400, 'lee', '배송 문의입니다.', '배송 문의입니다.', 32);
INSERT INTO board(goods_id, member_id, title, content, cate) VALUES(400, 'lee', '배송 문의입니다.', '배송 문의입니다.', 32);
INSERT INTO board(goods_id, member_id, title, content, cate) VALUES(400, 'lee', '배송 문의입니다.', '배송 문의입니다.', 32);
INSERT INTO board(goods_id, member_id, title, content, cate) VALUES(400, 'lee', '배송 문의입니다.', '배송 문의입니다.', 32);
INSERT INTO board(goods_id, member_id, title, content, cate) VALUES(400, 'lee', '배송 문의입니다.', '배송 문의입니다.', 32);
...
-- cate 33) '기타' (사용자 작성)
INSERT INTO board(goods_id, member_id, title, content, cate, com_status) VALUES(400, 'lee', '기타 문의입니다.', '기타 문의입니다.', 33, 'y');
INSERT INTO board(goods_id, member_id, title, content, cate, com_status) VALUES(400, 'lee', '기타 문의입니다.', '기타 문의입니다.', 33, 'y');
INSERT INTO board(goods_id, member_id, title, content, cate, com_status) VALUES(400, 'lee', '기타 문의입니다.', '기타 문의입니다.', 33, 'y');
INSERT INTO board(goods_id, member_id, title, content, cate, com_status) VALUES(400, 'lee', '기타 문의입니다.', '기타 문의입니다.', 33, 'y');
INSERT INTO board(goods_id, member_id, title, content, cate, com_status) VALUES(400, 'lee', '기타 문의입니다.', '기타 문의입니다.', 33, 'y');
INSERT INTO board(goods_id, member_id, title, content, cate) VALUES(400, 'lee', '기타 문의입니다.', '기타 문의입니다.', 33);
INSERT INTO board(goods_id, member_id, title, content, cate) VALUES(400, 'lee', '기타 문의입니다.', '기타 문의입니다.', 33);
INSERT INTO board(goods_id, member_id, title, content, cate) VALUES(400, 'lee', '기타 문의입니다.', '기타 문의입니다.', 33);
INSERT INTO board(goods_id, member_id, title, content, cate) VALUES(400, 'lee', '기타 문의입니다.', '기타 문의입니다.', 33);
INSERT INTO board(goods_id, member_id, title, content, cate) VALUES(400, 'lee', '기타 문의입니다.', '기타 문의입니다.', 33);
...
-- cate 4) '상품 후기' (사용자 작성)
INSERT INTO board(goods_id, member_id, title, content, cate) VALUES(400, 'lee', '너무 도움 많이 됐어요!', '엑셀 못 해서 늘 고생이었는데 이 도서 덕분에 많이 배웠습니다!', 4);


-- 게시판 댓글 테이블 더미 데이터
-- cate 2) '서비스 문의' (사용자 작성)에 대한 댓글 (관리자 작성)
INSERT INTO board_comment(brd_id, com_content, member_id) VALUES(16, '답변입니다.', 'admin');
INSERT INTO board_comment(brd_id, com_content, member_id) VALUES(17, '답변입니다.', 'admin');
INSERT INTO board_comment(brd_id, com_content, member_id) VALUES(18, '답변입니다.', 'admin');
INSERT INTO board_comment(brd_id, com_content, member_id) VALUES(19, '답변입니다.', 'admin');
INSERT INTO board_comment(brd_id, com_content, member_id) VALUES(20, '답변입니다.', 'admin');

-- cate 31) '환불' (사용자 작성)에 대한 댓글 (관리자 작성)
INSERT INTO board_comment(brd_id, com_content, member_id) VALUES(31, '답변입니다.', 'admin');
INSERT INTO board_comment(brd_id, com_content, member_id) VALUES(32, '답변입니다.', 'admin');
INSERT INTO board_comment(brd_id, com_content, member_id) VALUES(33, '답변입니다.', 'admin');
INSERT INTO board_comment(brd_id, com_content, member_id) VALUES(34, '답변입니다.', 'admin');
INSERT INTO board_comment(brd_id, com_content, member_id) VALUES(35, '답변입니다.', 'admin');

-- cate 32) '배송' (사용자 작성)에 대한 댓글 (관리자 작성)
INSERT INTO board_comment(brd_id, com_content, member_id) VALUES(46, '답변입니다.', 'admin');
INSERT INTO board_comment(brd_id, com_content, member_id) VALUES(47, '답변입니다.', 'admin');
INSERT INTO board_comment(brd_id, com_content, member_id) VALUES(48, '답변입니다.', 'admin');
INSERT INTO board_comment(brd_id, com_content, member_id) VALUES(49, '답변입니다.', 'admin');
INSERT INTO board_comment(brd_id, com_content, member_id) VALUES(50, '답변입니다.', 'admin');

-- cate 33) '기타' (사용자 작성)에 대한 댓글 (관리자 작성)
INSERT INTO board_comment(brd_id, com_content, member_id) VALUES(61, '답변입니다.', 'admin');
INSERT INTO board_comment(brd_id, com_content, member_id) VALUES(62, '답변입니다.', 'admin');
INSERT INTO board_comment(brd_id, com_content, member_id) VALUES(63, '답변입니다.', 'admin');
INSERT INTO board_comment(brd_id, com_content, member_id) VALUES(64, '답변입니다.', 'admin');
INSERT INTO board_comment(brd_id, com_content, member_id) VALUES(65, '답변입니다.', 'admin');
