          ...
          <c:when test="${item.orderId != pre_order_id }">
            <tr>
              ...
              <td>
                <c:choose>
                  <c:when test="${item.deliveryState=='delivery_prepared'}">
                    <input class="cancel_available" type="button" onClick="fn_cancel_order('${item.orderId}')"
                           value="주문취소"/>
                  </c:when>
                  <c:otherwise>
                    <input class="cancel_unavailable" type="button" onClick="fn_cancel_order('${item.orderId}')"
                           value="주문취소" disabled/>
                  </c:otherwise>
                </c:choose>
              </td>
