...
<script type="text/javascript">
  ...
  function loadComment() {
    $.ajax({
      type: "GET",
      url: "${contextPath}/reportComment/commentList.do?brdId=${dto.brdId}",
      dataType: "Json",
  ...
  $("#add_btn").click(
          function() {
            ...
            $.ajax({
              type: "POST",
              url: "${contextPath}/reportComment/addComment.do",
  ...
  $("#comment_list").on("click", "button:contains('삭제')",
          function() {
            ...
            $.ajax({
              type: "POST",
              url: "${contextPath}/reportComment/deleteComment.do",
  ...
  $("#comment_list").on("click", "#save_btn", function() {
    ...
    $.ajax({
      type: "POST",
      url: "${contextPath}/reportComment/updateComment.do",
